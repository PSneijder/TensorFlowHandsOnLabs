...
tf.app.flags.DEFINE_string('image_dir', '{0}/flower_photos'.format(getBaseFolder()),
                           """Path to folders of labeled images.""")
tf.app.flags.DEFINE_string('output_graph', '{0}/output_graph.pb'.format(getBaseFolder()),
                           """Where to save the trained graph.""")
tf.app.flags.DEFINE_string('output_labels', '{0}/output_labels.txt'.format(getBaseFolder()),
                           """Where to save the trained graph's labels.""")
tf.app.flags.DEFINE_string('summaries_dir', '{0}/retrain_logs'.format(getBaseFolder()),
...
tf.app.flags.DEFINE_string('model_dir', '{0}/imagenet'.format(getBaseFolder()),
                           """Path to classify_image_graph_def.pb, """
                           """imagenet_synset_to_human_label_map.txt, and """
                           """imagenet_2012_challenge_label_map_proto.pbtxt.""")
tf.app.flags.DEFINE_string(
    'bottleneck_dir', '{0}/bottleneck'.format(getBaseFolder()),
...
IMAGE_LABELS_DIR = '{0}/flower_photos/labels'.format(getBaseFolder())
...
ALL_LABELS_FILE = "{0}/labels.txt".format(getBaseFolder())
